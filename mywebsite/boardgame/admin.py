...
from .models import Event, Category, GroupPost, GroupPostComment, Tag, Game, Group, EventAttendance, GroupLocation, GroupMembers, UserProfile, EventLocation, GameSignup, GameComment, Vote
